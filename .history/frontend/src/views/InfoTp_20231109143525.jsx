...
export default function InfoTp() {
  ...
  const [updatedContainer, setUpdatedContainer] = useState(null);

  const handleSubmit = (event) => {
    event.preventDefault();
    axios
      .put(
        `http://localhost:8081/stockage/updateContainer/${selectedContainer.id}`,
        {
          conteneur_num_conteneur: updatedContainer,
        }
      )
      .then((response) => {
        ...
        // Refresh your container list here
      })
      .catch((error) => {
