...
export default function HistoricConteneur() {
  ...
  const columns = [
    { name: "id", selector: "projet_id" },
    { name: "id", selector: "conteneur_id" },
    { name: "Projet", selector: "nom_projet" },
    { name: "Client", selector: "nom_client" },
    {
      cell: (row) => (
        <div>
          <Link
            className="openModalBtn button_pers"
            to={`/container/historicConteneur/infoConteneur/${row.conteneur_id}/${row.projet_id}`}
          >
