      ...
      <div className="card align">
        ...
        <div className="transport_step">
          <div className="transport_step_container card">
            {currentStep === -1 && ( // Affichez "please select a container" lorsque currentStep est -1
              <div className="step">
                <div className="step_-container">
          ...
          <div className="transport_step_footer">
            <Stepper
              steps={[
                { title: "please select a container" }, // Étape 0 pour "please select a container"
                { title: "location" },
                { title: "transport" },
                { title: "validation" },
              ]}
              activeStep={currentStep >= 0 ? currentStep : 0} // Démarrez à partir de l'étape 0 si currentStep est -1
            />
          </div>
        </div>
      </div>
