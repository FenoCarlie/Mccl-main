...
export default function InfoProjet() {
  ...
  const segments = currentPath.split("/"); // Divise le chemin de l'URL en segments
  const pathWithoutLastSegment = segments.slice(0, -1).join("/"); // Supprime le dernier segment et rejoint le reste
  console.log(pathWithoutLastSegment);
                ...
                <div className="align projet-info-header contenue">
                  ...
                  <label className="">
                    {conteneur.status === 1 ? (
                      ...
                      "http://localhost:5173/projet/infoProjet" ? (
                        <Link
