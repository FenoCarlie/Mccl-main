...
export default function Historic() {
    ...
    const formattedDateIn = format(new Date(historics.date_in), 'dd/MM/yyyy');
    const formattedDateOut = format(new Date(historics.date_out), 'dd/MM/yyyy');
