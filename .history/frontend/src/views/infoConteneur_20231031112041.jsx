...
export default function InfoConteneur() {
  ...
  const onSubmit = (ev) => {
    ...
    if (
      ...
      axios
        .post("http://localhost:8081/create/transport_terrestre/import", {
      ...
      axios
        .post("http://localhost:8081/create/transport_terrestre/transfert", {
          id_transport: mouvements.id_transport,
          date_depart: mouvements.date_depart,
          date_arriver: mouvements.date_arriver,
          conteneur_id: mouvements.conteneur_id,
      ...
      axios
        .post("http://localhost:8081/create/transport_rail/transfert", {
          id_transport: mouvements.id_transport,
          date_depart: mouvements.date_depart,
          date_arriver: mouvements.date_arriver,
          conteneur_id: mouvements.conteneur_id,
      ...
      axios
        .post("http://localhost:8081/create/transport_rail/import", {
          id_transport: mouvements.id_transport,
          date_depart: mouvements.date_depart,
          date_arriver: mouvements.date_arriver,
          conteneur_id: mouvements.conteneur_id,
      ...
      axios
        .post("http://localhost:8081/create/transport_terrestre/export", {
          id_transport: mouvements.id_transport,
          date_depart: mouvements.date_depart,
          date_arriver: mouvements.date_arriver,
          conteneur_id: mouvements.conteneur_id,
      ...
      axios
        .post("http://localhost:8081/create/transport_rail/export", {
          id_transport: mouvements.id_transport,
          date_depart: mouvements.date_depart,
          date_arriver: mouvements.date_arriver,
          conteneur_id: mouvements.conteneur_id,
