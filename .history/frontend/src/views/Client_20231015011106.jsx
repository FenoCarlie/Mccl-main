...
export default function Client() {
  ...
  onst ContextMenu = ({ id, handleProjetClick, handleModifierClick }) => {
  ...
  const columns = [
    ...
    { name: "Contacte", selector: "contacte" },
    {
      cell: (row) => (
        <div>
          <ContextMenuTrigger id={`context-menu-${row.id}`}>
            <button className="openModalBtn button_pers">
          ...
          <ContextMenu
            ...
            handleModifierClick={() => {
              // Handle the "Modifier" click event
            }}
          />
        </div>
      ),
