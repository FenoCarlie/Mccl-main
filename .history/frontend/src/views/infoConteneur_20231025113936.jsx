                      ...
                      <div>
                        {typeProjet === "import" && (
                          <>
                            ...
                            <div className="input-container">
                              <label htmlFor="Depotage" className="input-label">
                                Depotage
                              </label>
                              <input
                                placeholder="Depotage"
                                className="input-field"
                                type="text"
                          ...
                          <>
                            ...
                            <div className="input-container">
                              ...
                              <input
                                ...
                                className="input-field"
                                type="date"
                                value={mouvements.date_pick_up_empty}
                                onChange={(ev) =>
                                  setMouvements({
                                    ...mouvements,
                            ...
                            <div className="input-container">
                              <label htmlFor="stuffing" className="input-label">
                                Stuffing
                              </label>
                              <input
                                ...
                                className="input-field"
                                type="text"
                                value={mouvements.loc_stuffing}
                                onChange={(ev) =>
                                  setMouvements({
                                    ...mouvements,
                                    loc_stuffing: ev.target.value,
                                  })
                                }
                                id="loc_stuffing"
                              />
                            ...
                            <div className="input-container">
                              ...
                              <input
                                ...
                                className="input-field"
                                type="date"
                                value={mouvements.date_stuffing}
                                onChange={(ev) =>
                                  setMouvements({
                                    ...mouvements,
                                    date_stuffing: ev.target.value,
                                  })
                                }
                                id="date_stuffing"
                              />
