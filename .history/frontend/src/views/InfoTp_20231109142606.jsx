  ...
  return (
    <div className="tp">
      ...
      >
        ...
        {selectedContainer && (
          <div>
            <p>Conteneur Num: {selectedContainer.conteneur_num_conteneur}</p>
            <p>Projet Nom: {selectedContainer.projet_nom_projet}</p>
            {/* Add your form or additional information here */}
          </div>
        )}
      </Modal>
    </div>
