...
export default function InfoConteneur() {
  ...
  const commonData = useState({
    id_transport: conteneur.id_transport,
    date_depart: conteneur.date_depart,
    date_arriver: conteneur.date_arriver,
    conteneur_id: conteneur.conteneur_id,
  ...
  const selectedUrl = urlMappings[selectedMouvement][conteneur.type_projet];
