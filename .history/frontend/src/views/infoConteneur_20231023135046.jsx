                  ...
                  <>
                    ...
                    <div className="button-mouvement">
                      ...
                      <button
                        ...
                        onClick={() => {
                          setCurrentStep(currentStep + 1);
                          setSelectedMouvement("depotage");
                        }}
                      >
                        <span className="button__text">Depotage</span>
                      </button>
                      <button
                        className="continue-application"
                        onClick={() => {
                          setCurrentStep(currentStep + 1);
                          setSelectedMouvement("déplacement");
                        }}
                      >
                        <span className="button__text">Déplacement</span>
                      </button>
                    </div>
                  </>
                ) : currentStep === 1 ? (
                  <>
                    {selectedMouvement === "empotage" && (
                      <div>
                        <h1>Empotage</h1>
                      </div>
                    )}

                    {selectedMouvement === "depotage" && (
                      <div>
                        <h1>Depotage</h1>
                      </div>
                    )}
                    {selectedMouvement === "déplacement" && (
                      <div>
                        <h1>deplacement</h1>
                      </div>
                    )}
