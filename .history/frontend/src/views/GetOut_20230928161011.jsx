...
return (
    ...
    <div className="align">
        ...
        <div className="test">
            ...
            <div className="align">
                <div className="align">
                <label htmlFor="num_container" className="">
                    Number of container
                </label>
                    <input placeholder="Number of container" className="input-field" type="text" value={container.num_container} onChange={handleNumContainerChange} id="num_container" maxLength="11"/>
