...
export default function Projet() {
  ...
  const handleModifyProjetClick = (projetId) => {
    // Chargez les données du projet depuis le serveur en utilisant un appel API similaire à getProjetDetails
    axios
      .get(`http://localhost:8081/projet/${projetId}`)
      .then(({ data }) => {
        setProjetToModify(data);
        setIsModalProjeOpen(true); // Ouvrez la modal de modification
      })
      .catch(() => {
        setLoading(false);
      });
    ...
    <div>
      ...
      <div className="align">
        ...
        <Modal
          ...
          onRequestClose={() => setIsModalModifyProjeOpen(false)}
          contentLabel="Projet Modal"
          style={customStylesModal}
        >
          ...
          <div className="input-container">
            ...
            <input
              ...
              className="input-field"
              type="text"
              value={selectedProjet ? selectedProjet.client_projet : ""}
              onChange={(ev) =>
                setProjet({
                  ...selectedProjet,
                  client_projet: ev.target.value,
          ...
          <div className="input-container">
            ...
            <input
              ...
              className="input-field"
              type="text"
              value={selectedProjet ? selectedProjet.nom_projet : ""}
              onChange={(ev) =>
                setProjet({
                  ...selectedProjet,
                  nom_projet: ev.target.value,
          ...
          <div className="input-container">
            ...
            <input
              ...
              className="input-field"
              type="text"
              value={selectedProjet ? selectedProjet.num_booking : ""}
              onChange={(ev) =>
                setProjet({
                  ...selectedProjet,
                  num_booking: ev.target.value,
