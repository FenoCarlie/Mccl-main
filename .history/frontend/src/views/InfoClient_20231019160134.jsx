      ...
      >
        ...
        <div className="input-container">
          ...
          <input
            ...
            className="input-field"
            type="text"
            value={client.nom} // Pré-remplissez avec les données actuelles
            onChange={(ev) => setClient({ ...client, nom: ev.target.value })}
            id="nom"
          />
        </div>

        {/* Ajoutez d'autres champs pour d'autres informations du client à modifier. */}
