...
export default function InfoConteneur() {
  ...
  const optionslieu_restitution = [
    { label: "Italia", location: "Italia" },
    { label: "Autre...", location: "autre" },
  ];
  ...
  const handleSelectTp = (ev) => {
    setMouvements({ ...mouvements, tp_id: ev.target.value });
    setTp(ev.target.value);
  };
  const handleSelectReastitution = (ev) => {
  ...
  const commonData = {
    transport_id: mouvements.id_transport,
  ...
  if (selectedMouvement === "transport_terrestre") {
    if (conteneur.type_projet === "Import") {
      ...
      selectedUrl = urlMappings.transport_terrestre.Import;
      if (mouvements.lieu_restitution === "Italia") {
        const newProjectName = "RES" + conteneur.nom_projet.substring(3);
        commonData.nom_projet = newProjectName;
        commonData.client_id = conteneur.client_projet;
        commonData.etat = "Vide";
        commonData.type_projet = "Stockage";
      }
      ...
      commonData.lieu_depotage = mouvements.lieu_depotage;
      commonData.date_depotage = mouvements.date_depotage;
      selectedUrl = urlMappings.transport_terrestre.Transfert;
      ...
      selectedUrl = urlMappings.transport_terrestre.Export;
    }
    ...
    if (conteneur.type_projet === "Import") {
      ...
      commonData.lieu_restitution = mouvements.lieu_restitution;
      commonData.date_restitution = mouvements.date_restitution;
      selectedUrl = urlMappings.transport_rail.Import;
    } else if (conteneur.type_projet === "Transfert") {
      commonData.num_camion = mouvements.num_camion;
      commonData.num_permis = mouvements.num_permis;
      commonData.nom_chauffeur = mouvements.nom_chauffeur;
      ...
      commonData.lieu_restitution = mouvements.lieu_restitution;
      commonData.date_restitution = mouvements.date_restitution;
      selectedUrl = urlMappings.transport_rail.Transfert;
    } else if (conteneur.type_projet === "Export") {
      commonData.num_wagno = mouvements.num_wagno;
      commonData.num_plateforme = mouvements.num_plateforme;
      commonData.lieu_enlevement_vide = mouvements.lieu_enlevement_vide;
      ...
      commonData.lieu_livraison = "MICTSL";
      commonData.date_livraison = mouvements.date_livraison;
      selectedUrl = urlMappings.transport_rail.Export;
    }
  } else if (selectedMouvement === "stockage") {
    commonData.tp_id = mouvements.tp_id;
    selectedUrl = "stockage";
  }
                  ...
                  <>
                              ...
                              <div className="align">
                                <div className="input-container">
                                  ...
                                  <select
                                    className="input-field"
                                    value={type}
                                    onChange={handleSelectReastitution}
                                    id="type"
                                  >
                                    <option
                                      value=""
                                    ...
                                    {optionslieu_restitution.map((option) => (
                                      <option
                                        key={option.value}
                                        value={option.value}
                                        className="custom-option"
                    ...
                    {selectedMouvement === "transport_rail" && (
                      <div>
                        ...
                        <div className="input-container">
                          <label htmlFor="date_depart" className="input-label">
                            Date de depart
                          </label>
                          <input
                            placeholder="Date de depart"
