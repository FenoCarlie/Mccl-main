...
export default function Projet() {
  ...
  const getProjetDetails = (projectId) => {
    axios
      .get(`http://localhost:8081/get/projet/${projectId}`)
      .then(({ data }) => {
        setProjets(data);
      })
      .catch(() => {
  ...
  const handleProjetClick = (projectId) => {
    setSelectedProjet(projectId);
    getProjetDetails(projectId);
  };
        ...
        <div className="card animated fadeInDown w-500">
          ...
          <div className="list">
            <ul>
              <li>
                Projet:
                <label className="info_label">{projets.num_projet}</label>
              </li>
              <li>
                Client:
