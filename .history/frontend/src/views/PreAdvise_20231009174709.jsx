...
export default function PreAdvise() {
  ...
  const [pick_up_empty, setPick_up_empty] = useState("");
  const optionsType = [
  ...
  const handleSelectPick_up_empty = (ev) => {
    setContainer({ ...container, pick_up_empty: ev.target.value });
    setpick_up_empty(ev.target.value);
  };
                    ...
                    <div className="align">
                      <div className="input-container">
                        <select
                          ...
                          onChange={handleSelectPick_up_empty}
                          id="line"
                        >
                          <option
                            value=""
