...
export default function InfoConteneur() {
  ...
  //const [typeProjet, setTypeProjet] = useState("import");
  const typeProjet = "transfert";
  ...
  const getConteneur = (conteneurId, projetId) => {
    axios
      .get(
  ...
  useEffect(() => {
    getConteneur(conteneurId, projetId);
    getTransport();
    getClient();
  ...
  const onSubmit = (ev) => {
    ...
    if (
      ...
      axios
        .post("http://localhost:8081/creat/transport_terrestre_import", {
          ...
          lieu_enlevement_plein: "MICTSL",
          date_enlevement_plein: mouvements.date_enlevement_plein,
          date_depotage: mouvements.date_depotage,
          lieu_depotage: mouvements.lieu_depotage,
          lieu_restitution: mouvements.lieu_restitution,
          date_restitution: mouvements.date_restitution,
        })
        .then(() => {
      ...
      axios
        .post("http://localhost:8081/creat/transport_terrestre_transfert", {
          id_transport: mouvements.id_transport,
          date_depart: mouvements.date_depart,
          date_arriver: mouvements.date_arriver,
          conteneur_id: mouvements.conteneur_id,
          ...
          num_permis: mouvements.num_permis,
          nom_chauffeur: mouvements.nom_chauffeur,
          lieu_enlevement_plein: mouvements.lieu_enlevement_plein,
          date_enlevement_plein: mouvements.date_enlevement_plein,
          date_depotage: mouvements.date_depotage,
          lieu_depotage: mouvements.lieu_depotage,
          lieu_restitution: mouvements.lieu_restitution,
      ...
      axios
        .post("http://localhost:8081/creat/transport_rail_transfert", {
          id_transport: mouvements.id_transport,
          date_depart: mouvements.date_depart,
          date_arriver: mouvements.date_arriver,
          conteneur_id: mouvements.conteneur_id,
      ...
      axios
        .post("http://localhost:8081/creat/transport_rail_import", {
          id_transport: mouvements.id_transport,
          date_depart: mouvements.date_depart,
          date_arriver: mouvements.date_arriver,
          conteneur_id: mouvements.conteneur_id,
      ...
      axios
        .post("http://localhost:8081/creat/transport_terrestre_export", {
          id_transport: mouvements.id_transport,
          date_depart: mouvements.date_depart,
          date_arriver: mouvements.date_arriver,
          conteneur_id: mouvements.conteneur_id,
          ...
          num_permis: mouvements.num_permis,
          nom_chauffeur: mouvements.nom_chauffeur,
          lieu_enlevement_vide: mouvements.lieu_enlevement_vide,
          date_enlevement_vide: mouvements.date_enlevement_vide,
          date_empotage: mouvements.date_empotage,
          lieu_empotage: mouvements.lieu_empotage,
          lieu_livraison: "MICTSL",
          date_livraison: mouvements.date_livraison,
        })
        .then(() => {
          setNotification("Le mouvement a été effectué avec succès");
          setLoading(true);
      ...
      axios
        .post("http://localhost:8081/creat/transport_rail_export", {
          id_transport: mouvements.id_transport,
          date_depart: mouvements.date_depart,
          date_arriver: mouvements.date_arriver,
          conteneur_id: mouvements.conteneur_id,
