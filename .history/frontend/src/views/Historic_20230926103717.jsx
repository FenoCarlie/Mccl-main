    ...
    const customStyles = {
        ...
        const columns = [
            ...
            { 
              ...
              selector: "date_in",
              format: (row) => {
                return format(row.date_in ? new Date(row.date_in) : null, 'dd/MM/yyyy');
              }
            },
            ...
            { 
              ...
              selector: "date_out",
              format: (row) => {
                return format(row.date_out && row.date_out !== "0000-00-00" ? new Date(row.date_out) : null, 'dd/MM/yyyy') || "In progress";
              }
            },
            {
        }
