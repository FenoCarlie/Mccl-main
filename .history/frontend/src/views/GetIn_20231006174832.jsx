...
export default function GetIn() {
  ...
  return (
    <div className="card">
      <div className="card-list-getIn align">
        <div className="card-getin shadow list">
          <ul>
            ...
            <li>
              Client :<label className="info_label"> {container.client} </label>
            </li>
            <li>
              Category :
            ...
            <li>
              Status :<label className="info_label"> {container.status} </label>
            </li>
            <li>
              Location :
