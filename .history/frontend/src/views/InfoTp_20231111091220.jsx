...
export default function InfoTp() {
  ...
  const [selectedContainerShift, setSelectedVideContainerShift] =
    useState(null);
  ...
  const handleSubmitShift = (event) => {
    ...
    axios
      .put(
        `http://localhost:8081/stockage/Shifting/${selectedContainerShift.id}`,
        updatedContainer
      )
      .then((response) => {
        console.log(response.data);
  ...
  return (
    <div className="tp">
            ...
            vide.map((vide) => (
              <>
                <div className="tp-info-container" key={vide.id}>
                  ...
                  <div className="actionTp">
                    <button>Depotage</button>
                    <button
                      onClick={() => {
                        setIsModalShiftignOpen(true);
                        setSelectedVideContainerShift(vide);
                      }}
                    >
                      Shifting
                    </button>
          ...
          <div>
            ...
            <form onSubmit={handleSubmit}>
              <div className="input-container">
                <label htmlFor="date_enlevement_vide" className="input-label">
                  Emplacement
                </label>
                <input
                  type="text"
      ...
      <Modal
        ...
        style={customStylesModal}
      >
        {selectedContainerShift && (
          <div>
            <h2>{selectedContainerShift.conteneur_num_conteneur}</h2>
            <div className="align contenue">
              <p>
                <strong>Position actuel :</strong>
              </p>
              <p>{selectedContainerShift.position}</p>
            </div>
            <form onSubmit={handleSubmitShift}>
              <label>Nouveau position:</label>
              <div className="align contenue">
                <input
                  type="text"
                  value={updatedPosition}
