...
export default function Projet() {
  ...
  const getProjet = () => {
    ...
    axios
      ...
      .then(({ data }) => {
        setLoading(false);
        setProjet(data); // Assurez-vous que data est un tableau ici
        setFilteredProjet(data); // Assurez-vous que data est un tableau ici
      })
      .catch(() => {
        setLoading(false);
      });
  ...
  const onSubmitProjet = (ev) => {
    ...
    axios
      ...
      .then(() => {
        ...
        setErrors({});
        // Rechargez la liste des projets pour inclure le nouveau projet
        getProjet();
      })
      .catch((err) => {
