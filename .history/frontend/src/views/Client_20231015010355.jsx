...
export default function Client() {
  ...
  const handleFetchProjects = (clientId) => {
    getProjet(clientId);
  };

  const handleModifyClient = (clientId) => {
    // Logic to modify the selected client
  };
      ...
      <div className="align">
        <div className="card animated fadeInDown w-700">
          ...
          <ContextMenu id="context-menu">
            <MenuItem onClick={(e, data) => handleFetchProjects(data.clientId)}>
              Fetch Projects
            </MenuItem>
            <MenuItem onClick={(e, data) => handleModifyClient(data.clientId)}>
              Modify Client
            </MenuItem>
          </ContextMenu>
        </div>
