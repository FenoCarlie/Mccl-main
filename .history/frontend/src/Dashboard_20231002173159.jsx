    ...
    axios
      ...
      .then((response) => {
        ...
        const handleTimeUnitChange = (event) => {
          ...
          console.log(selectedTimeUnit); // Ajoutez cette ligne pour le débogage
    ...
    <div>
      ...
      <div className="radio-input">
        <input
          ...
          onChange={() => handleTimeUnitChange("month")}
        />
        ...
        <input
          ...
          onChange={() => handleTimeUnitChange("day")}
        />
        ...
        <input
          ...
          onChange={() => handleTimeUnitChange("week")}
        />
        <label htmlFor="week">Par semaine</label>
      </div>
      <div>
