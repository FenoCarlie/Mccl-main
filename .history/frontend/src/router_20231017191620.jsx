...
import InfoContainer from "./views/modals/InfoContainer.jsx";
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      {
        path: "/client/infoClient/infoProjet/infoConteneur/:conteneurId",
      ...
      {
        path: "/projet/infoProjet/infoConteneur/:conteneurId",
        element: <InfoConteneur />,
      },
      {
        path: "/container",
      ...
      {
        path: "/container/infoProjet/infoConteneur/:conteneurId",
        element: <InfoConteneur />,
      },
      {
        path: "/transport",
