    ...
    if (err) {
      ...
      db.query(conteneurQuery, [projetIds], (err, conteneurResult) => {
        if (err) {
          ...
          // Créez un objet pour stocker les statistiques par projet
          ...
          projetResult.forEach((projet) => {
            ...
            // Ajoutez les statistiques à l'objet projetDetails
            ...
            // Stockez les statistiques dans l'objet statsParProjet
            statsParProjet[projet.id] = projet;
          });
