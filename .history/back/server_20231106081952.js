...
app.post("/create/transport_terrestre/import", (req, res) => {
  ...
  db.query(insertMouvementSql, insertMouvementValues)
    .then((result) => {
      ...
      // Utilisez Promise.all pour exécuter les deux requêtes en parallèle
      return Promise.all([
        db.query(insertTransportSql, insertTransportValues),
        db.query(insertImportSql, insertImportValues),
      ]);
    })
    .then(() => {
      res
