...
app.post("/create/transport_terrestre/transfert", (req, res) => {
  ...
  db.query(insertMouvementSql, insertMouvementValues, (err, result) => {
    ...
    const insertTransfertSql = `
      INSERT INTO transfert (lieu_enlevement_plein, date_enlevement_plein, lieu_restitution, date_restitution, mouvement_id) VALUES (?, ?, ?, ?, ?)
    `;
...
app.post("/create/transport_terrestre/export", (req, res) => {
  ...
  db.query(insertMouvementSql, insertMouvementValues, (err, result) => {
    ...
    const insertTransportSql = `
      INSERT INTO transport_terrestre (num_camion, num_camion, num_permis, nom_chauffeur, transport_id, date_depart, mouvement_id) VALUES (?, ?, ?, ?, ?, ?)
      `;
