  ...
  export default function ContainerForm() {
    ...
    const items = ['Type1', 'Type2', 'Type3']; // replace with your types

function MyComponent() {
  const [container, setContainer] = React.useState({ type: '' });
    ...
    return (
      <>
        ...
        <div className="card card_width animated fadeInDown">
          ...
          <div className="input-container">
      <Downshift
        selectedItem={container.type}
        onInputValueChange={(inputValue) => setContainer({ ...container, type: inputValue })}
      ...
      >
        {({
          ...
          <div>
            <label {...getLabelProps()} htmlFor="type" className="input-label">
              Type
            </label>
            <input {...getInputProps({ placeholder: 'Type' })} className="input-field" />
            <ul {...getMenuProps()}>
              {isOpen &&
                items
