  ...
  export default function ContainerForm() {
    ...
    const options = [
      {label: "", value: "" },
      {label: "20' flate Rigide", value: "20' flate Rigide" },
      {label: "20' flate Ripe", value: "20' flate Ripe" },
      {label: "40' flate Rigide", value: "40' flate Rigide" },
      {label: "40' flate Ripe", value: "40' flate Ripe" },
    ]
    ...
    return (
      <>
        ...
        <div className="card card_width animated fadeInDown">
          ...
          <div className="align">
          <div className="input-container">
              <select className="input-field" onChange={handleSelect}>
                {options.map(option =>  (
                  <option value={option.value} placeholder="Type">{option.label}</option>
                ))}
              </select>
