  ...
  useEffect(() => {
    // Exemple d'appel AJAX vers le backend pour obtenir des suggestions
    axios.get(`/api/suggestions?query=${inputValue}`)
      .then((response) => {
        setSuggestions(response.data); // Mettez à jour les suggestions avec la réponse du serveur
      })
      .catch((error) => {
        console.error(error);
      });
