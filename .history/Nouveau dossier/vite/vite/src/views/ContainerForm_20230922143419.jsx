  ...
  export default function ContainerForm() {
    ...
    const handleNumContainerChange = (ev) => {
      ...
      // Limiter la saisie à 11 caractères
      ...
      // Vérifications
      if (inputValue.length !== 11) {
        setNumContainerError("Le numéro de conteneur doit avoir 11 caractères.");
      } else if (!/^[A-Za-z]{4}\d{7}$/.test(inputValue)) {
        setNumContainerError("Le numéro de conteneur doit commencer par 4 lettres suivies de 7 chiffres.");
      } else {
      ...
      <>
        ...
        <div className="card card_width animated fadeInDown">
          ...
          <div className="input-container">
            ...
            {numContainerError && <p className="error-message">{numContainerError}</p>}
          </div>
