    ...
    return (
      <>
        ...
        <div className="card card_width animated fadeInDown">
          ...
          <div className="input-container">
            {/* Champ de saisie spécifique pour Truck */}
            <input
              placeholder="Champ pour Truck"
              className="input-field"
              type="text"
              value={/* La valeur du champ pour Truck */}
              onChange={(ev) => setContainer({ ...container, /* Mettre à jour le champ pour Truck */ })}
            />
            <label htmlFor="truckField" className="input-label">
              Champ pour Truck
            </label>
            <span className="input-highlight"></span>
          </div>
        ...
        {selectedTransport === 'Rail' && (
          <div className="input-container">
            {/* Champ de saisie spécifique pour Rail */}
            <input
              placeholder="Champ pour Rail"
              className="input-field"
              type="text"
              value={/* La valeur du champ pour Rail */}
              onChange={(ev) => setContainer({ ...container, /* Mettre à jour le champ pour Rail */ })}
            />
            <label htmlFor="railField" className="input-label">
              Champ pour Rail
            </label>
            <span className="input-highlight"></span>
          </div>
