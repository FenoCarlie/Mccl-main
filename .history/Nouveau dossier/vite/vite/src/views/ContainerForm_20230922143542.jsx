  ...
  export default function ContainerForm() {
    ...
    const handleNumContainerChange = (ev) => {
      ...
      if (inputValue.length !== 11) {
        setNumContainerError("The container number must be 11 characters long.");
      } else if (!/^[A-Za-z]{4}\d{7}$/.test(inputValue)) {
        setNumContainerError("The container number must begin with 4 letters followed by 7 digits.");
      } else {
