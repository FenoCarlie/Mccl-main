  ...
  export default function ContainerForm() {
    ...
    const options = [
      { label: "20' Dry Van", value: "20' Dry Van" },
      ...
      { label: "20' Open Side", value: "20' Open Side" },
      { label: "40' Dry Van", value: "40' Dry Van" },
      { label: "40' High Cube (HC)", value: "40' High Cube (HC)" },
      ...
      { label: "40' Open Side", value: "40' Open Side" },
      { label: "40' Double Door", value: "40' Double Door" },
      { label: "40' High Cube Palletwide", value: "40' High Cube Palletwide" },
      { label: "40' Open Top Hard Top", value: "40' Open Top Hard Top" },
    ];
    ...
    return (
      <>
        ...
        > 
          <option value="" disabled hidden className="Type" style="color: red;">
            Type
          </option>
          {options.map((option) => (
