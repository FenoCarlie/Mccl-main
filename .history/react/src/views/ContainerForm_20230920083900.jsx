...
<div className="input-container">
  <input placeholder="Line" className="input-field" type="text" value={container.live}
...
<div className="input-container">
  <input placeholder="Departure" className="input-field" type="text" value={container.position}
